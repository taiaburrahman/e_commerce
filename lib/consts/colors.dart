...
const Color grey = Color.fromRGBO(210, 210, 210, 1);
//
const Color scaffoldColor = Color.fromARGB(255, 232, 241, 236);
//Font color
const fontColorBlack = Colors.black;
const greencolor = Color.fromARGB(255, 75, 204, 80);
